...
public class JanelaPrincipal extends JFrame
{
	...
	private JMenuItem mniNovo, mniAbrir, mniSalvar, mniSair, mniRotular8,
			mniSobre, mniEscalamento, mniTranslacao, mniRotacao, mniEspelhamento;
	...
	public JanelaPrincipal()
	{
		...
		super("Trabalho 03 - Editor de Imagens Binarias Sinteticas");
		...
		mniEscalamento = new JMenuItem("Escalamento...");
		mniTranslacao = new JMenuItem("Translacao...");
		mniRotacao = new JMenuItem("Rotacao...");
		mniEspelhamento = new JMenuItem("Espelhamento...");
		...
		mnuOperacoes.addSeparator();
		mnuOperacoes.add(mniTranslacao);
		mnuOperacoes.add(mniEscalamento);
		mnuOperacoes.add(mniRotacao);
		mnuOperacoes.add(mniEspelhamento);
	...
	{
		return mniEscalamento;
	}

	public JMenuItem getMniEspelhamento()
	{
		return mniEspelhamento;
	}

	public JMenuItem getMniRotacao()
	{
		return mniRotacao;
	}

	public JMenuItem getMniTranslacao()
	{
		return mniTranslacao;
	}
